/*
    * File: pythontopics.tsx
    * Description: This is the Python topics screen. 
...
export default function PythonTopics() {
    {/* Remove expo header */}
    ...
    return(
        <View style={styles.outerContainer}>
            ...
            <View style={styles.container}>
                <Text style={styles.title}>Python Programming Topics</Text>
